<?php
    if(isset($_POST['create_post'])){
        ...
        if($post_status == 'Published'){
          echo "<p class='bg-success'>Post titled: '{$post_title}' by {$post_author} posted successfully. " .
          " <a href='../post.php?p_id=$the_post_id'>View Post</a></p>";
        } else {
          echo "<p class='bg-success'>Post titled: '{$post_title}' by {$post_author} posted in Drafts to be reviewed. Post can be
          edited under <a href='posts.php' style='color:green;'>'View all Posts'</a></p>";
        };
    };
?>
